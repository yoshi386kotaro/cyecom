...
(function() {
  ...
  Layer = L.Class.extend({
    defaultI18n: {
      ...
      ru: {
        currentTemperature: "ﾐ｢ﾐｵﾐｼﾐｿﾐｵﾑﾐｰﾑびτﾐｰ",
        maximumTemperature: "ﾐ慴ｰﾐｺﾑ�. ﾑひｵﾐｼﾐｿ",
        minimumTemperature: "ﾐ慴ｸﾐｽ. ﾑひｵﾐｼﾐｿ",
        humidity: "ﾐ漬ｻﾐｰﾐｶﾐｽﾐｾﾑ�び�",
        wind: "ﾐ漬ｵﾑひｵﾑ",
        show: "ﾐ｡ﾐｽﾐｵﾐｳ",
        snow_possible: "ﾐ漬ｾﾐｷﾐｼﾐｾﾐｶﾐｵﾐｽ ﾑ�ｽﾐｵﾐｳ",
        rain: "ﾐ頒ｾﾐｶﾐｴﾑ�",
        rain_possible: "ﾐ漬ｾﾐｷﾐｼﾐｾﾐｶﾐｵﾐｽ ﾐｴﾐｾﾐｶﾐｴﾑ�",
        icerain: "ﾐ嶢ｵﾐｴﾑ紹ｽﾐｾﾐｹ ﾐｴﾐｾﾐｶﾐｴﾑ�",
        rime: "ﾐ寅ｾﾐｻﾐｾﾐｻﾐｵﾐｴ",
        rime_possible: "ﾐ漬ｾﾐｷﾐｼﾐｾﾐｶﾐｵﾐｽ ﾐｳﾐｾﾐｻﾐｾﾐｻﾐｵﾐｴ",
        clear: "ﾐｯﾑ�ｽﾐｾ"
      }
    },
    ...
    buildMarker: function(st, ll) {
      ...
      popupContent += "<p>";
      popupContent += "" + this.i18n.currentTemperature + ":&nbsp;" + (this.toCelc(st.temp)) + "&nbsp;ﾂｰC<br />";
      if (st.temp_max) {
        popupContent += "" + this.i18n.maximumTemperature + ":&nbsp;" + (this.toCelc(st.temp_max)) + "&nbsp;ﾂｰC<br />";
      }
      if (st.temp_min) {
        popupContent += "" + this.i18n.minimumTemperature + ":&nbsp;" + (this.toCelc(st.temp_min)) + "&nbsp;ﾂｰC<br />";
      }
